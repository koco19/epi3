...
KoCo_BLab <- KoCo_BLab[, c("ind_id", "hh_id", "Age")]
...
Const <- read.csv(here_koco_data("R1/KoCo19_Haushalte4Modeler_wRRstartConstituency_20200910.csv"))
# 3007 hh
...
Munich_hh <- read.csv(here_koco_data("R1/muc_hh_structure_KoCo_study_pop.csv"))
...
load(here_koco_data("R1/contiguity_matrices-munich-constituencies_200914.RData"))
