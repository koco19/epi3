...
#
# We use the table KoCo_19_2021_09_30.xlsx as entry
########################################################
...
data_age_sex <- read.xlsx(here_koco_data("R4/KoCo_19_2021_09_30.xlsx"), sheet = "Blatt 12 - Geschlecht Alter",
                     colNames = FALSE, rows = 762, cols = 8:39)


names_age_sex <- read.xlsx(here_koco_data("R4/KoCo_19_2021_09_30.xlsx"), sheet = "Blatt 12 - Geschlecht Alter",
...
data_age_sex$x[data_age_sex$Age == "15-19 Jahre" & 
                 data_age_sex$Sex %in% c("m?nnlich", "weiblich")] <- data_age_sex$x[data_age_sex$Age == "15-19 Jahre" & 
                                                                     data_age_sex$Sex %in% c("m?nnlich", "weiblich")] + c(6095, 5671)
...
# Export
write.csv(data_age_sex, here_koco_data("R4/muc_age_structure_KoCo_study_pop.csv"), row.names = FALSE)
