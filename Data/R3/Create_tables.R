...
#
# We use the table KoCo19_202103-3.xlsx as entry
########################################################
...
###
# Age and Sex distribution at 31.03.21
###

data_age_sex <- read.xlsx(here_koco_data("R3/KoCo19_202103-3.xlsx"), sheet = "Blatt 12 - Geschlecht Alter",
                     colNames = FALSE, rows = 762, cols = 8:39)


names_age_sex <- read.xlsx(here_koco_data("R3/KoCo19_202103-3.xlsx"), sheet = "Blatt 12 - Geschlecht Alter",
...
data_age_sex$x[data_age_sex$Age == "15-19 Jahre" & 
                 data_age_sex$Sex %in% c("m?nnlich", "weiblich")] <- data_age_sex$x[data_age_sex$Age == "15-19 Jahre" & 
                                                                     data_age_sex$Sex %in% c("m?nnlich", "weiblich")] + c(6137, 5591)
...
# Export
write.csv(data_age_sex, here_koco_data("R3/muc_age_structure_KoCo_study_pop.csv"), row.names = FALSE)
